...
이 작품은 웹툰으로 큰 인기를 얻었으며, 현재 드라마 제작이 진행 중입니다. 주요 배우 캐스팅이 완료되었으며, 2023년 3분기에 촬영을 시작할 예정입니다.`,
  ...
  // 나머지 투자 가능한 웹툰 데이터는 유지하되 isDramatized 필드 추가
  {
    ...
    isDramatized: false,
    summary:
      "몰락한 귀족 가문의 후계자가 시간을 되돌려 가문을 재건하는 과정을 그린 판타지 작품입니다. 정치적 음모와 성장 스토리가 잘 어우러진 인기작입니다. 주인공 아델라인은 한때 명문 귀족이었던 가문의 마지막 후계자로, 가문이 몰락한 후 비참한 삶을 살다 죽음을 맞이합니다. 그러나 신비한 힘에 의해 어린 시절로 돌아가게 되고, 전생의 기억을 간직한 채 이번에는 가문의 몰락을 막고 가주가 되기 위해 노력합니다. 정교한 세계관과 치밀한 정치 음모, 그리고 주인공의 성장을 그린 매력��인 판타지 작품입니다.",
