...
이 작품은 웹툰으로 큰 인기를 얻었으며, 현재 드라마 제작이 진행 중입니다. 주요 배우 캐스팅이 완료되었으며, 2023년 3분기에 촬영을 시작할 예정입니다.`,
  ...
  },
  {
    ...
    isDramatized: false,
    summary:
      "검술명가의 막내아들이 가문의 비밀을 알게 되면서 시작되는 모험과 성장을 그린 작품입니다. 화려한 액션과 탄탄한 스토리로 많은 사랑을 받고 있습니다. 주인공 진서하는 명문 검술 가문의 막내아들로 태어났지만, 형제들과 달리 검술에 재능이 없어 가문 내에서 소외받고 있습니다. 그러던 중 우연히 가문의 숨겨진 비밀과 함께 자신만의 특별한 능력을 발견하게 되고, 이를 통해 가문을 위협하는 거대한 음모에 맞서게 됩니다. 화려한 검술 액션과 함께 성장하는 주인공의 이야기가 매력적으로 펼쳐집니다.",
  ...
  },
  {
    ...
    isDramatized: false,
    summary:
      "마법의 세계에서 인간 소녀와 마법사의 만남을 그린 판타지 로맨스입니다. 아름다운 세계관과 감성적인 스토리로 많은 사랑을 받고 있습니다. 어린 시절부터 특별한 능력으로 인해 소외받던 소녀 치세는 자신을 노예 경매장에 내놓게 됩니다. 그곳에서 그녀를 구매한 것은 동물의 두개골을 가진 신비한 마법사 엘리아스. 그는 치세를 제자이자 신부로 삼겠다고 선언합니다. 마법과 요정이 존재하는 신비로운 세계에서 치세는 자신의 능력을 받아들이고 성장해가며, 엘리아스와 특별한 유대를 형성해갑니다. 아름다운 판타지 세계관과 섬세한 감정 묘사가 돋보이는 작품입니다.",
