...
이 작품은 웹툰으로 큰 인기를 얻었으며, 현재 드라마 제작이 진행 중입니다. 주요 배우 캐스팅이 완료되었으며, 2023년 3분기에 촬영을 시작할 예정입니다.`,
  ...
  },
  {
    ...
    isDramatized: false,
    summary:
      "검술명가의 막내아들이 가문의 비밀을 알게 되면서 시작되는 모험과 성장을 그린 작품입니다. 화려한 액션과 탄탄한 스토리로 많은 사을 받고 있습니다. 주인공 진서하는 명문 검술 가문의 막내아들로 태어났지만, 형제들과 달리 검술에 재능이 없어 가문 내에서 소외받고 있습니다. 그러던 중 우연히 가문의 숨겨진 비밀과 함께 자신만의 특별한 능력을 발견하게 되고, 이를 통해 가문을 위협하는 거대한 음모에 맞서게 됩니다. 화려한 검술 액션과 함께 성장하는 주인공의 이야기가 매력적으로 펼쳐집니다.",
  ...
  // 나머지 투자 가능한 웹툰 데이터는 유지하되 isDramatized 필드 추가
  {
    ...
    isDramatized: false,
    summary:
      "몰락한 귀족 가문의 후계자가 시간을 되돌려 가문을 재건하는 과정을 그린 판타지 작품입니다. 정치적 음모와 성장 스토리가 잘 어우러진 인기작입니다. 주인공 아델라인은 한때 명문 귀족이었던 가문의 마지막 후계자로, 가문이 몰락한 후 비참한 삶을 살다 죽음을 맞이합니다. 그러나 신비한 힘에 의해 어린 시절로 돌아가게 되고, 전생의 기억을 간직한 채 이번에는 가문의 몰락을 막고 가주가 되기 위해 노력합니다. 정교한 세계관과 치밀한 정치 음모, 그리고 주인공의 성장을 그린 매력인 판타지 작품입니다.",
  ...
  },
  {
    ...
    isDramatized: false,
    summary:
      "냉철한 CEO와 그의 비밀을 알게 된 비서의 로맨스를 그린 작품입니다. 성인 소재를 다루고 있어 19세 이상 시청가로 제작되었습니다. 주인공 서지민은 대기업 CEO 강도윤의 비서로 일하게 됩니다. 완벽주의자이자 냉철한 성격의 강도윤은 직원들에게 두려움의 대상이지만, 서지민은 우연히 그의 숨겨진 약점과 비밀을 알게 니다. 이를 계기로 두 사람 사이에 특별한 관계가 형성되고, 서로의 상처를 치유해가는 과정을 그립니다. 성인 소재를 다루면서도 캐릭터의 심리와 관계 발전에 초점을 맞춘 작품입니다.",
