              ...
              <form onSubmit={handleLogin} className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    >
                      {showPassword ? <EyeOff className="h-4 w-4 text-gray" /> : <Eye className="h-4 w-4 text-gray" />}
                    </Button>
                  </div>
                </div>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray dark:bg-darkblue dark:text-light">소셜 계정으로 계속하기</span>
              </div>
            </div>

            <div className="mt-6 space-y-3">
              {/* 카카오 로그인 버튼 */}
              {/* 카카오 브랜드 가이드라인에 맞춘 색상(#FEE500)과 텍스트 색상(검정)을 적용 */}
              {/* 카카오는 한국에서 가장 인기 있는 메신저 앱으로, 소셜 로그인 시 많이 사용됨 */}
              <Button
              ...
              {/* 네이버 로그인 버튼 */}
              {/* 네이버 브랜드 가이드라인에 맞춘 색상(#03C75A)과 텍스트 색상(흰색)을 적용 */}
              {/* 네이버는 한국의 대표적인 포털 사이트로, 많은 사용자가 네이버 계정을 보유하고 있음 */}
              <Button
              ...
              {/* 구글 로그인 버튼 */}
              {/* 구글 브랜드 가이드라인에 맞춘 흰색 배경과 경계선, 텍스트 색상을 적용 */}
              {/* 구글 계정은 전 세계적으로 사용되며, 한국에서도 많은 사용자가 있음 */}
              <Button
              ...
              >
                <div className="flex items-center">
                  <div className="w-6 h-6 rounded-full flex items-center justify-center mr-2">
                    <span className="text-darkblue font-bold text-sm">G</span>
                  </div>
                  <span>구글로 계속하기</span>
                </div>
              </Button>
